...
function DashSec() {
    ...
    const { toastSuccess } = useProductsContext()
            ...
            case 'minhas-redacoes':
                return <div >
                    ...
                    <div className="card flex justify-content-center">
                        ...
                        <Button label="Submit" onClick={() => toastSuccess('Redação enviada!', 2000)} icon="pi pi-check" iconPos="right" />
                    </div>
        ...
        <>
            ...
            <main className="containerDash">
                ...
                <aside className="content">
                    ...
                    <Bubble typebot="escola-ut79s2v" theme={{ button: { backgroundColor: "#00796b" } }} />
                </aside>
